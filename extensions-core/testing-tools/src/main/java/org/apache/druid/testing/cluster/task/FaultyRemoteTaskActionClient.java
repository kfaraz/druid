...
{
  private final Logger log = new Logger(FaultyRemoteTaskActionClient.class);

  private final TaskActionClient delegate;

  FaultyRemoteTaskActionClient(TaskActionClient delegate)
  {
  ...
  {
    log.warn("Submitting a faulty task action");
