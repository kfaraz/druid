...
import org.apache.druid.server.coordinator.rules.Drop;
...
public class RunRulesTest
{
  ...
  private final DataSegment[] segments =
      CreateDataSegments.ofDatasource(DATASOURCE_WIKI)
  ...
  public void testOneTierTwoReplicantsWithStrictReplicantLimit()
  {
    ...
    Assert.assertEquals(10L, stats.getSegmentStat(Stats.Segments.ASSIGNED, Tier.T2, DATASOURCE_WIKI));
  }
  ...
  public void testTwoTiersTwoReplicantsWithStrictReplicantLimit()
  {
    ...
    Assert.assertEquals(48L, stats.getSegmentStat(Stats.Segments.ASSIGNED, Tier.T2, DATASOURCE_WIKI));
  }
  ...
  public void testLoadByIntervalOnThreeTiers()
  {
    ...
    Assert.assertEquals(12L, stats.getSegmentStat(Stats.Segments.ASSIGNED, Tier.T3, DATASOURCE_WIKI));
