 ...
 * <p>
 * Requests are naturally ordered using the {@link #COMPARATOR_ACTION_THEN_INTERVAL}.
 */
public class SegmentHolder implements Comparable<SegmentHolder>
{
   ...
   * </ul>
   */
  public static final Comparator<SegmentHolder> COMPARATOR_ACTION_THEN_INTERVAL =
  ...
  {
    return Objects.compare(this, that, COMPARATOR_ACTION_THEN_INTERVAL);
  }
