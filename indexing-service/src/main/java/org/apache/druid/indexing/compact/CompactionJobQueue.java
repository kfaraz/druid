 ...
 */
public class CompactionJobQueue implements Iterator<CompactionJob>
{
  private final PriorityQueue<CompactionJob> queue;

  public CompactionJobQueue(CompactionCandidateSearchPolicy searchPolicy)
  {
  ...
  public List<CompactionJob> getPendingJobs()
  {
